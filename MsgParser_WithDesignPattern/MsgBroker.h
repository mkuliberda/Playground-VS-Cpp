...
public:
	...
	virtual bool publishData(const ExternalObject& _recipient, const InternalObject& _publisher, std::unordered_map<std::string, int32_t> _values, const bool& _wait_until_cplt = false) =0;
	...
	virtual bool setEncoder(Visitor *_encoder) =0;
