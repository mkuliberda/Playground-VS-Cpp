...
public:
	...
	virtual bool publishData(const ExternalObject& _recipient, const char* _publisher, std::unordered_map<const char*, int32_t> _values, const bool& _wait_until_cplt = false) =0;
	...
	virtual void setAddresses(std::unordered_map<ExternalObject_t, std::string>& _addresses) =0;
